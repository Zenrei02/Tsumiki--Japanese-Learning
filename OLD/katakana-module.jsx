...
const COLS = [
  ...
  { key: "wa", name: "W-Series", kana: ["ワ", "",   "",   "",   "ヲ"], sounds: ["wa", "", "", "", "o"] },
];
...
const MODULES = [
  ...
  { id: "wa", kind: "kana", col: "wa",
    title: "W-Series & ン", sounds: "wa o n", en: "the last three",
  ...
  { id: "cc-wasei", kind: "culture", all: true, dakuten: true, small: true, bar: true, ext: true,
    title: "Careful: fake English", sounds: "", en: "和製英語",
    exp: "One last warning, and it is the important one.\n\nSome katakana words were assembled in Japan out of English parts and do not exist in English at all. They are called 和製英語 — English made in Japan. The difficulty is not that they are hard to read. It is that many Japanese speakers believe they are English, and will use them with you expecting to be understood.\n\nSo the failure runs both ways. You will not recognise the word, and they will not know it is not English. Being aware of the category is most of the defence.",
    notes: [
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 13, color: T.sub, marginBottom: 8 }}>
        {listen ? "Listen, then write what you hear" : "Write this word — one character per box"}
      </div>
      {listen ? (
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 10, flexWrap: "wrap" }}>
        ...
        <span title={k.full} style={{
          ...
          border: `1px solid ${k.color}`, color: k.color, fontFamily: stage === 2 ? T.jpFont : T.uiFont,
        ...
        <header style={{ display: "flex", alignItems: "baseline", gap: 14, marginBottom: 6 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: T.sub }}>
              {mod ? mod.title : `Stage 1 · ${doneCount} of ${MODULES.length} lessons`}
            </div>
          </div>
        </header>
        ...
        {mod ? (
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: T.sub, marginTop: 16, paddingBottom: 12,
              ...
              {stage === 0 && "Kana · SB skill builder · CC culture connection · CP checkpoint — nothing is gated yet."}
              {stage === 1 && "Kana 字 · SB 技 · CC 街 · CP 復 — the Japanese labels start appearing now."}
              {stage === 2 && "字 kana · 技 skill builder · 街 culture connection · 復 checkpoint."}
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 20 }}>
              {MODULES.map((m) => {
                ...
                return (
                  <button key={m.id} className={"row-btn" + (m.kind === "culture" ? " row-cc" : "")}
                    ...
                    <span style={{ fontFamily: hasJP(m.title) ? T.jpFont : T.uiFont, fontSize: 16 }}>{m.title}</span>
