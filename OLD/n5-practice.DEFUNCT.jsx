      ...
      {annotate(text).map((sg, i) =>
        sg.entry ? (
          <span
            ...
            style={{ borderBottom: `1px dashed ${sg.entry[3] === "KNOWN" ? "#9A9DA3" : "#B08A1F"}`, cursor: "pointer" }}
          >
    ...
    points: [
      {
        ...
        exp: {
          what: "は is a spotlight. It says \"here's what I'm talking about\" — and everything after it is a comment on that thing. It is not a subject marker, and it does not mean \"is.\"",
          build: "Place は directly after the thing you're spotlighting. It's written with the character は but pronounced wa. This spelling quirk applies only to the particle, never to は inside a word.",
