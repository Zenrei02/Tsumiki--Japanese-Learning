# Curriculum order v1 — 2026-08-10
...
The ledger holds **288** words. Only **101** are introduced anywhere; the remaining **187** are `KANJI_DICT` display entries and kanji-card samples — reachable and glossable, never taught. That gap is the finding. There is no missing *sequence*; there is a missing *syllabus*.

### 3a. Defect — the Step 2 split cloned its bank

No two steps share a bank.

### 3b. Recurrence — the gap Session 3 named, now measured

- Words appearing in more than one bank: **18 of 101**
- Of those, recurring **only** at a checkpoint: **16**
...
These are the N4 stress-test bank — arguably correct to exclude as out-of-stage, but it happens by regex accident rather than by decision, and the ledger reports 95 bank words where the file has 101.
...
| 22 | 来週 | らいしゅう | next week | 2 | 1/2 | never in Stage 1 | 4.5 |
| 23 | 火曜日 | かようび | Tuesday | 2 | 2/3 | never in Stage 1 | 4.5 |
| 24 | 町 | まち | town | 2 | 1/1 | #48 | 4.5 |
| 25 | 電話 | でんわ | telephone | 2 | 1/2 | never in Stage 1 | 4.5 |
| 26 | 上 | うえ | above | 1 | 1/1 | #30 | 3.5 |
| 27 | 中 | なか | inside | 1 | 1/1 | #19 | 3.5 |
| 28 | 休む | やすむ | to rest | 1 | 1/1 | #61 | 3.5 |
| 29 | 何時 | なんじ | what time | 1 | 2/2 | #50 | 3.5 |
| 30 | 八つ | やっつ | eight things | 1 | 1/1 | #17 | 3.5 |
...
- Taught words that are kana-only and always render plain: **6**
- Taught words that **never** render plain inside the 63-character syllabus: **74**

Those words keep furigana for the whole of Stage 1:

> お茶、一緒に、仕事、会う、会議、作る、使う、全部、公園、写真、写真を撮る、冬、前、勉強する、友達、図書館、夏、妹、安い、家、宿題、寒い、寝る、帰る、広い、座る、待つ、忘れる、忙しい、思う、急ぐ、手を洗う、散歩する、新しい、日本語、映画、昼ごはん、暑い、最後まで、月曜日、朝ごはん、机、果物、歌、歯をみがく、毎日、牛乳、犬、猫、痛い、窓、簡単、終わる、肉、落とす、薬を飲む、財布、買う、起きる、遅れる、部屋、野菜、銀行、開ける、雨が降る、電気、電車、静か、面白い、音楽、頭、駅、高い、魚

This is working as designed — §2 says kanji state changes how a word looks, never whether it appears — but it is worth seeing the size of it. Roughly 73% of the taught vocabulary is still ruby-annotated at the end of Stage 1, which sets the honest expectation for how much of the 'quietly stops needing ruby' moment the learner actually gets.
...
Only **19** of the 101 taught words get a promotion event at all, and they do not cluster at the front — 5 land in the first thirty characters and the rest are spread through the tail. The demand term front-loads the *characters*, but a word needs **every** one of its characters, so a word's promotion is governed by its latest character, not its earliest. That is worth stating plainly because it is the opposite of what the ordering rationale implies, and it means the re-render moment is a rarer event than `word-kanji-scheduling-v1.md` §2 assumes when it calls it 'a genuine product moment'. It is still worth building — but on this syllabus it fires 19 times, not continuously.
...
**No character unlocks more than two words, and 87 of the 92 unlock exactly one.** The distribution is flat — there is no high-leverage pick, and ranking the queue barely matters because every entry is worth about the same.

Worse, clearing furigana from all 74 blocked words would take **92 new characters** — the syllabus would have to grow from 64 to 156, and 21 of those words need two or three of them before anything visible happens.
