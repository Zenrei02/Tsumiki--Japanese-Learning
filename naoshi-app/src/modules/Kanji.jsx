...
const MODULES = [
  ...
  { id: "k-verbs", kind: "kanji", title: "Five verbs you already say", chars: ["見","行","来","食","話"],
    exp: "These five are almost certainly already in your mouth — you have been saying 見る, 行く, 来る, 食べる and 話す since your first lessons. All that is new is the written form.\n\nThat is a much easier task than learning a character cold, and it is why the order works the way it does: kanji arrive for words you can already say, not as abstract shapes with meanings attached.\n\n見 is an eye 目 on legs 儿. 話 is words 言 and a tongue 舌." },
