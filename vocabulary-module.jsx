...
// 110 taught words of 322 in the ledger; 62 ever enter this module, 82 total visits, 52 can become fully writable in Stage 1.
...
const WORDS = [
  ...
  {w:"図書館",r:"としょかん",m:"library",k:["書"],u:["図","館"],s:"Step 2 · Core particles"},
  ...
  {w:"果物",r:"くだもの",m:"fruit",k:["物"],u:["果"],s:"Step 10 · Comparing & preferring"},
...
const STEP_POINTS = {"Step 0 · Before any Japanese": ["prim-shape", "prim-drop"], "Step 1 · Your first sentences": ["desu", "kosoado", "janai", "deshita", "ka", "qwords", "ne", "yo", "cc-greetings", "b-s1"], "Step 2 · Core particles": ["wa", "ga", "sb-waga", "o", "ni-time", "ni-dest", "sb-kanaparticles", "de-place", "de-means", "sb-nide", "b-s2a"], "Step 3 · Joining, choosing & counting": ["to-and", "mo", "no", "sb-pronouns", "kara-from", "yori", "ka-or", "ya", "dake", "shika", "counters", "gurai", "goro", "sb-slots", "b-s2b"], "Step 4 · Verbs: from dictionary form up": ["dict", "masu", "sb-verbtypes", "ta-plain", "mashita", "te", "b-s3a", "teiru", "teiru2", "sb-transitive", "b-s3c", "cc-teru", "mou", "mada", "sb-future", "sb-register", "sb-nounmod", "b-s3b", "b1", "rc1"], "Step 5 · Requests, permission & obligation": ["tekudasai", "naidekudasai", "temoii", "tewaikemasen", "nakereba", "nakutemoii", "b-s4"], "Step 6 · Invitations, desire & intention": ["mashou", "mashouka", "masenka", "tai", "hoshii", "tsumori", "niiku", "b-s5"], "Step 7 · Linking actions & time": ["tekara", "atode", "maeni", "nagara", "taritari", "kata", "toki", "deshou", "b-s6", "b2", "rc2"], "Step 8 · Existence & possession": ["arimasu", "motteiru", "location", "sb-nide2", "ageru", "cc-konbini", "b-s7"], "Step 9 · Adjectives & adverbs": ["iadj", "naadj", "kute", "narimasu", "shimasu-change", "nisuru", "amari", "zenzen", "totemo", "cc-slang", "b-s8"], "Step 10 · Comparing & preferring": ["hou", "ichiban", "suki", "jouzu", "wakaru", "nogasuki", "potential", "sb-transitive2", "sb-ganotwo", "b-s9"], "Step 11 · Reasons, contrast & connectors": ["kara-because", "node", "ga-but", "demo", "toiu", "doushite", "nanika", "sb-orthography", "sb-waga2", "sb-pronouns2", "b-s10"], "Step 12 · Past N5 · the shape-changers": ["sb-omou", "passive", "tara", "b-s11", "b3", "rc3", "teshimau", "S1", "S2", "S3", "S4", "S5"]};
// @@WORDS-END@@
